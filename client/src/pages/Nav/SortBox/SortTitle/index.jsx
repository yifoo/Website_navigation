        ...
        {(provided, snapshot) => (
          ...
          >
            ...
            {sortList.map((item, key) => {
              return (
                <Draggable isDragDisabled={!isOrderable} key={item.sortId} draggableId={'sort' + item.sortId} index={key}>
                  {(provided, snapshot) => (
                    <dd
                      key={item.sortId}
                      ref={provided.innerRef}
                      ...
                      className={`${style.subSort} ${key === activekey ? style.active : ''} ${isOrderable ? style.drag : ''}`}
            ...
            <EditSubSort sortId={data.sortId} color={data.color} />
            {props.isEdit && (
