...
function ua(e) {
  ...
  } else if (r = e.match(/360ChromeBrowser\/([^\s]+)/ig)) {
    var r1 = r[0].split("/");
    outputer = '<span class="ua_360ee"><i class="fa fa-globe"></i> 360极速浏览器' + ' ' + r1[1]
...
(function(e, t, n) {
  ...
  function pt(e) {
    w.theme = e, e != "none" && w.injectStylesheet(b + "/styles/embed" + (e ? "." + e + ".css?" + y[e] : "." + short_name) + ".css")
  }
  if (e.DUOSHUO) return;
  var r = e.location,
    i = e.JSON,
    ...
    d = function(e) {
      ...
      return n.href = e, x.hrefNormalized ? n.href : n.getAttribute("href", 4)
    },
    v = {
      start: 0,
      end: 0
    ...
    w = e.DUOSHUO = {
      ...
      require: function(e, t) {
        if (typeof e == "string") w.loaded[e] ? t() : F(w.libs[e], function() {
          w.loaded[e] = !0, t()
        });
      ...
      ajax: function(e, t, r, o, u) {
        ...
        r.v = w.version, a ? r.jwt = a : z.remote_auth && (r.remote_auth = z.remote_auth);
        if (s && i && i.parse) {
          var f = new s;
          if (!!f && "withCredentials" in f) {
            ...
            f.open(e, w.hostUrl + t + ".json" + (e == "GET" ? "?" + w.param(r) : ""), !0), f.withCredentials = !0, f.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), f.send(e == "GET" ? null : w.param(r)), l = function(e, t) {
              var r, i, s, o;
              try {
        ...
        w[h] = function(e) {
          switch (e.code) {
            case 0:
              ...
              break;
            default:
              u && u(e), I("\u51fa\u9519\u5566(" + e.code + "): " + e.errorMessage), e.errorTrace && I(e.errorTrace)
          }
        }, r.callback = "DUOSHUO['" + h + "']", F(w.hostUrl + t + ".jsonp?" + w.param(r))
      },
      ...
      setCustomStyle: function(e) {
        h || (h = t.createElement("style"), h.type = "text/css", a.appendChild(h)), e = e.replace(/\}/g, "}\n");
    ...
    S, x = w.support = function() {
      ...
      return S = !s && typeof n.style.maxHeight == "undefined", u.authInWin = e.postMessage && e.screen.width > 800 && !u.iOS && !u.android && r.origin, u
    }(),
    T = function(e, n) {
    ...
    D = function(t) {
      ...
      _.push(i.stringify(t)), M || (M = w.webSocket = new WebSocket("ws://ws.duoshuo.com:8201/"), M.onopen = function() {
        var e;
        if (M.readyState === 1)
        ...
        switch (r.type) {
          case "post":
            for (; t < w.pagelets.length; t++) n = w.pagelets[t], n.threadId == r.thread_id && n.onMessage(r);
            break;
          case "notification":
            O.push(r), lt();
            break;
    ...
    j = w.openDialog = function(e) {
      return w.dialog !== n && w.dialog.el.remove(), w.dialog = (new H.Dialog('<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' + e + '</div><a class="ds-dialog-close" href="javascript:void(0)" title="\u5173\u95ed"></a></div></div>')).open()
    },
    F = w.injectScript = function(r, i) {
      ...
      s.type = "text/javascript", s.src = r, s.async = "async", s.charset = "utf-8", i && (s.onload = s.onreadystatechange = function(t, r) {
        if (r || !s.readyState || /loaded|complete/.test(s.readyState)) s.onload = s.onreadystatechange = null, o && s.parentNode && o.removeChild(s), s = n, r || i.call(e)
  ...
  var J = w.templates = {
      ...
      loginUrl: function(e, t) {
        return t || (t = {}), z.sso && z.sso.login && (t.sso = 1, t.redirect_uri = z.sso.login), w.hostUrl + "/login/" + e + "/" + W(t)
      },
      bindUrl: function(e) {
  ...
  for (; U < R.length; U++) w[R[U]] = function(e) {
    return function(t, n) {
      n = n || {}, n.type = e, t && !N[t] && (N[t] = n), w.initSelector && w.initSelector(t, n)
    }
  }(R[U]), w["create" + R[U]] = function(e) {
    return function(n, r) {
  ...
  tt.on("queryDefined", function() {
    var e = z.short_name;
    w.hostUrl = e ? l + "//" + e + "." + w.DOMAIN : w.REMOTE, z.theme && pt(z.theme);
    if (o) {
      var t = o["ds_site_" + e],
        n = o["ds_lang_" + e];
      t && nt.reset(i.parse(t)), n && ft(k, i.parse(n))
    }
  }), V(), w.loaded.jQuery && (w.jQuery = e.jQuery), w.require("jQuery", function() {
    function dt(e, t, n) {
      if (e.find(".ds-post[data-post-id=" + t.post_id + "]")[0]) return;
      return e.find(".ds-post-placeholder").remove(), i(J.post(t, n)).hide()[n.order == "asc" ? "appendTo" : "prependTo"](e).slideDown(function() {})
    }
    ...
    function vt(e, t) {
      ...
      this.delegate("a.ds-post-likes", "click", function(e) {
        if (ct()) return gt(), !1;
        var t = i(this).parent();
        return liked = t.hasClass("ds-post-liked"), matches = i(this).html().match(/\((\d+)\)/), likes = (matches ? parseInt(matches[1]) : 0) + (liked ? -1 : 1), A("/api/posts/vote", {
          post_id: t.closest(".ds-ctx-entry, .ds-post-self").attr("data-post-id"),
          vote: liked ? 0 : 1
        }), i(this).html(i(this).html().replace(/\(\d+\)/, "") + (likes ? "(" + likes + ")" : "")), t[liked ? "removeClass" : "addClass"]("ds-post-liked"), !1
        ...
        if (n.attr("data-root-id") == 0) {
          ...
          o[0] ? o.remove() : (o = i('<ul class="ds-children"></ul>').insertAfter(n), L("/api/posts/listComments", bt({
            ...
            l(e), o.append(i.map(e.response, function(e) {
              return J.post(e, t)
            }).join(""))
          }))
        }
      ...
      }), x.touch || this.delegate("a.ds-comment-context, .ds-avatar, .ds-user-name", "mouseenter", function(t) {
        var n = this;
        if (bubbleOutTimer && $.owner == n) clearTimeout(bubbleOutTimer), bubbleOutTimer = 0;
        else {
          var r = i(n);
          Y = setTimeout(function() {
            ...
            try {
              if (r.hasClass("ds-comment-context")) G.attr("id", "ds-ctx-bubble").attr("data-post-id", r.attr("data-post-id")).html('<ul id="ds-ctx">' + J.ctxPost(ot[r.attr("data-parent-id")].data) + "</ul>" + '<div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">\u67e5\u770b\u5bf9\u8bdd</a></div>');
                ...
                if (!f) throw "no info";
                G.attr("id", "ds-user-card").attr("data-user-id", f).empty(), ut[f] ? G.html(J.userInfo(ut[f].data)) : L("/api/users/profile", bt(a), function(e) {
                  var t = e.response;
                  ut[f] ? ut[f].set(t) : ut[f] = new et(t), $.owner == n && G.html(J.userInfo(t))
                })
              }
              $.css({
                bottom: o,
    ...
    var i = w.jQuery,
      ...
      l = w.loadRequire = function(e) {
        e.serverTime && (c = (new Date).getTime() - e.serverTime * 1e3), e.visitor && (!rt.data && e.visitor.user_id && u && !u.checkPermission() && D({
          logged_user_id: e.visitor.user_id
        }), rt.reset(e.visitor)), e.site && (nt.reset(e.site), ht("ds_site_" + z.short_name, e.site, e.serverTime)), !w.theme && nt.data.theme && pt(nt.data.theme), e.lang && (ft(k, e.lang), ht("ds_lang_" + z.short_name, e.lang, e.serverTime));
        if (e.stylesheets)
          for (var t = 0; t < e.stylesheets.length; t++) w.injectStylesheet(e.stylesheets[t]);
        e.nonce && (w.nonce = e.nonce), e.style && w.setCustomStyle((e.style || "") + w.compileStyle(z.component_style)), e.unread && it.reset(e.unread)
      },
      h = function(e) {
        e.stopPropagation()
      },
      ...
      _ = function(e) {
        return x.touch && e.addClass("ds-touch"), T("transition") || e.addClass("ds-no-transition"), S && e.addClass("ds-ie6"), i.support.opacity || e.addClass("ds-no-opacity"), e
      },
      B = function(e) {
        if (!x.placeholder) {
    ...
    var R = w.Widget = Z.extend({
        ...
        onMessage: function() {},
        onError: function(e) {
          I("\u51fa\u9519\u5566(" + e.code + "): " + e.errorMessage), e.errorTrace && I(e.errorTrace)
        }
      }),
      U = function(e) {
        var t = {
        ...
        i("#ds-notify").hide(), L(t.apiUrl, {}, function(e) {
    ...
    w.resetNotify = function() {
      ...
      }[nt.data.notify_position]).delegate(".ds-notify-unread a", "click", function(e) {
    ...
    }, it.on("reset", w.resetNotify), J.replybox = function(e, t) {
      var n = e.options,
        r = rt.data,
        i = [],
        s = "",
      ...
      for (var a in r.repostOptions) r.repostOptions[a] && (i.push(a), o = 1), s += J.serviceIcon(a, !r.repostOptions[a]);
      ...
      render: function(e) {
        function T(e) {
          e.data("submitting", !0), e.find(".ds-post-button").addClass("ds-waiting").html(k.posting)[0].disabled = !0
        }

        function N(e) {
          e.data("submitting", !1), e.find(".ds-post-button").removeClass("ds-waiting").html(k.post)[0].disabled = !1
        }
        var n = this,
          r = n.embedThread,
          s = r.options,
          ...
          d = a.find(".ds-add-emote").click(function(e) {
            ...
            return d.toggleClass("ds-expanded").hasClass("ds-expanded") ? (r || (r = w.smiliesTooltip = new H.SmiliesTooltip, r.render(), w.require("smilies", function() {
              r.reset("\u5fae\u535a-\u9ed8\u8ba4")
          ...
          b = a.find(".ds-add-image").click(function(e) {
            var n = h[0],
              ...
              s = '<img src="' + i + '" />';
            if (t.selection) {
              n.value = r.substring(0, v.start) + s + r.substring(v.end, r.length), n.value = n.value.replace("\u8bf4\u70b9\u4ec0\u4e48\u5427 ...", ""), n.focus();
          ...
          E = n.hideSmilies = function(e) {
            d.removeClass("ds-expanded"), w.smiliesTooltip.el.detach(), i(t.body).unbind("click", E)
          },
          S = function(e, t) {
            var n = j('<h2>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55</h2><div class="ds-icons-32">' + i.map(["weibo", "qq", "renren", "kaixin", "douban", "netease", "sohu"], function(e) {
        ...
        s.deny_anonymous && h.focus(function(e) {
          if (ct()) {
            S(f, C);
            var t = function(e) {
              e.stopPropagation(), h.unbind("click", t)
            };
            h.click(t)
          }
          return !1
        ...
        var C = function(e) {
          T(f), A("/api/posts/create", i.extend(w.toJSON(f), e), function(e) {
            var t = e.response,
              i = dt(n.postList, t, s);
            s.order == "asc" == (s.formPosition == "top") && w.scrollTo(i), ot[t.post_id] = new et(t), r.data.comments++, r.updateCounter("duoshuo"), h.val("").trigger("keyup"), N(f), a.hasClass("ds-inline-replybox") && (a.detach(), n.actionsBar.removeClass("ds-reply-active"));
            if (o) try {
        ...
        return c.click(function() {
          return i(this).toggleClass("ds-service-icon-grey").toggleClass("ds-service-icon"), l.value = i.map(c, L).join(","), l.checked = l.value != "", !1
        }), i(l).change(function() {
          var e = this.checked;
          c[e ? "removeClass" : "addClass"]("ds-service-icon-grey")[e ? "addClass" : "removeClass"]("ds-service-icon"), this.value = i.map(c, L).join(",")
        }), this
      }
    }, H.Dialog = Z.extend({
      init: function(e, t) {
        (this.el = i("#ds-wrapper"))[0] || (this.el = _(i('<div id="ds-wrapper"></div>'))), this.options = i.extend({
          width: 600
        }, t), e !== n && i(e).attr("id", "ds-reset").appendTo(this.el)
      },
      open: function() {
        var e = this;
        e.el.hide().appendTo(t.body).fadeIn(200), S && e.el.css("top", s.scrollTop() + 100), e.el.show().find(".ds-dialog").delegate("a.ds-dialog-close", "click", function(t) {
          return e.close(), !1
        }).click(h);
        var n = function(t) {
      ...
      render: function() {
        var r = this,
          ...
          a = u.find(".ds-like-thread-button").click(function(f) {
            ...
            return l ? r.tooltip && c(f) : (r.tooltip === n && (r.tooltip = i(J.likeTooltip(o)).click(h).delegate("a", "click", function(t) {
      ...
      render: function() {
        var e = this.embedThread,
          ...
          s = r.find("ul.ds-comments-tabs").delegate(".ds-tab a", "click", function(t) {
      ...
      n && n.el.find("ul.ds-smilies-tabs").append("<li><a>" + e + "</a></li>"), w.smilies[e] = t
    }, H.SmiliesTooltip = function() {}, H.SmiliesTooltip.prototype = {
      render: function() {
        var e = this,
          n = e.el = i(J.smiliesTooltip(q));
        return n.click(h).find("ul.ds-smilies-tabs").delegate("a", "click", function(t) {
          ...
          var r = e.replybox,
            ...
            s = i.value;
          if (t.selection) {
            i.value = s.substring(0, v.start) + this.title + s.substring(v.end, s.length), i.value = i.value.replace(k.leave_a_message, ""), i.focus();
            var o = t.selection.createRange();
            o.moveStart("character", v.start + this.title.length), o.collapse(), o.select()
          } else {
      ...
      reset: function(e) {
        ...
        var n = "<ul>";
        return i.each(q[e], function(t, r) {
          ...
          e === "WordPress" && (t = " " + t + " "), n += '<li><img src="' + i + '" title="' + p(t) + '" /></li>'
    ...
    var $ = i('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'),
      G = $.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click", function(e) {
    ...
    bubbleOut = function() {
    ...
    }, $.mouseenter(tt).mouseleave(bubbleOut), J.userInfo = function(e) {
      var t = [];
      ...
      refetch: function() {
        ...
        e.el.fadeTo(200, .5), L(e.url, e.params, function(t) {
          at(ot, t.parentPosts || t.relatedPosts), at(ut, t.users), e.reset(t.response), e.embedThread.paginator.reset(t.cursor), e.el.fadeTo(200, 1), w.scrollTo(e.el), n.remove()
        })
      }
      ...
      var i = j('<h2>\u8f6c\u53d1\u5230\u5fae\u535a</h2><div class="ds-quote"><strong>@' + p(K(e.data).name) + "</strong>: " + e.data.message + "</div>" + "<form>" + Q({
        ...
        s = i.el.find("form").submit(function(e) {
          return !r && !s.find("[type=checkbox]:checked")[0] ? (alert("\u8fd8\u6ca1\u6709\u9009\u53d1\u5e03\u5230\u54ea\u513f\u5462"), !1) : (A("/api/posts/repost", w.toJSON(s), function(e) {
            if (n && r) {
              var t = n.options,
      ...
      }), B(s.find("textarea")).keyup(g).keyup(y).focus(), !1
      ...
      render: function() {
        ...
        n ? e.data("url", d(n)) : e.data("container-url", r.href), t && t <= 400 && e.addClass("ds-narrow").data("max-depth", 1)
      },
      ...
      onload: function(t) {
        ...
        r.data = t.thread, at(ot, t.parentPosts || t.relatedPosts), at(ut, t.users), r.el.find("#ds-waiting").remove(), a.like_thread_enabled && (r.meta = new H.Meta(r), r.meta.render().el.appendTo(f)), a.hot_posts && t.hotPosts && t.hotPosts.length && (r.hotPosts = new H.HotPosts(i('<div class="ds-rounded"></div>'), {
          max_depth: 1,
          show_context: a.show_context
        }), r.hotPosts.thread = r, r.hotPosts.el.appendTo(f), r.hotPosts.onload({
          response: t.hotPosts,
          options: {}
        })), r.postListHead = new H.PostListHead(r), r.postList = new P.PostList({
          embedThread: r,
          params: {
            source: "duoshuo",
            thread_id: s,
        ...
        }), r.postList.render().reset(t.response), r.paginator = new H.Paginator({
        ...
        if (ct()) {
          var p = i(J.loginButtons()).delegate("a.ds-more-services", "click", function() {
            return p.find(".ds-additional-services").toggle(), !1
          });
          M(p)
        } else r.toolbar = i(J.toolbar()).delegate(".ds-account-control", "mouseenter", function() {
        ...
        }), a.message && c.val(a.message).focus(), i(J.poweredBy(a.poweredby_text)).appendTo(f), it.on("reset", function() {
          var e = it.data.comments || 0;
          f.find("a.ds-unread-comments-count").html(e).attr("title", e ? "\u4f60\u6709" + e + "\u6761\u65b0\u56de\u590d" : "\u4f60\u6ca1\u6709\u65b0\u56de\u590d").css("display", e ? "inline" : "none")
        }), a.mzadx_id && (w.require("mzadxN", function() {}), i('<div id="MZADX_' + a.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(f), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
          l: [a.mzadx_id],
          r: "1",
          _srv: "MZADX",
          _callback: function(e, t) {}
        })), w.thread = r, it.data !== n && it.trigger("reset"), ct() || D({
      ...
      return '<div class="ds-header ds-gradient-bg">' + k.hot_posts_title + "</div><ul>" + i.map(e, function(e) {
        return ot[e] ? J.post(ot[e].data, t) : ""
      }).join("") + "</ul>"
    }, H.HotPosts = R.extend({
      params: "show-quote",
      ...
      tmpl: "recentVisitors",
      render: function() {
        this.el.children().detach(), this.el.attr("id", "ds-recent-visitors").append(this.waitingEl = i(J.waitingImg()))
      }
      ...
      tmpl: "topUsers",
      render: function() {
        this.el.children().detach(), this.el.attr("id", "ds-top-users").append(this.waitingEl = i(J.waitingImg()))
      }
      ...
      tmpl: "topThreads",
      render: function() {
        this.el.children().detach(), this.el.attr("id", "ds-top-threads").append(this.waitingEl = i(J.waitingImg()))
      }
      ...
      render: function() {
        var e = this.el;
        e.attr("id", "ds-login").html(J.loginWidget()), M(e, "a"), e.find("a.ds-logout").attr("href", J.logoutUrl())
      }
    ...
    w.initSelector = function(e, t) {
      ...
      V() && (i.isReady || !E) && i(e).each(function(e, r) {
        ...
        if (t.type === "ThreadCount") {
          ...
          s.attr("data-channel-key") && (u = s.attr("data-channel-key") + ":" + u), n.push(u), st[u] || (st[u] = new et({})), st[u].on("reset", function() {
            o.onload(this)
          })
        } else if (o.uri) {
          var a = {};
